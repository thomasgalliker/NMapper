namespace NMapper
{
    public class MapperOptions
    {
        ...
        /// target type has been visited twice on one branch of the graph, which means the mapped
        /// result may contain more than one target instance for the same source. Cycles that run
        /// through a collection are not affected, because the collection is created by the mapper
        /// and is tracked before its elements are mapped.
        /// </para>
        /// </remarks>
